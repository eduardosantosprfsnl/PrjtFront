...
import HeaderOrc from "../components/gastos/HeaderOrc";
import Sidebar from "../components/gastos/Sidebar";
                ...
                <Box w="100%">
                    ...
                    <Box overflowY="auto" height="80vh">
                        <Table mt="6">
                            <Thead>
                                <Tr>
                                    <Th fontWeight="bold" fontSize="14px" >Despesa</Th>
                                    <Th fontWeight="bold" fontSize="14px" >Valor</Th>
                                    <Th></Th>
                                </Tr>
                            </Thead>
                            <Tbody>
                                {listStockEntries.map((item, i) => (
                                    <Tr key={i}>
                                        ...
                                        <Td color="gray.500" >R$ {item.amount}</Td>
                                        <Td textAlign="end" >
                                            <Button
                                            p="2"
                                            h="auto"
